				...
				defaults = {
					...
					addressTemplate: function(data){
						...
						var html = '<input type="hidden" id="address_'+idx+'_street_number" name="street_number_'+idx+'" value=""/>';
							...
							html +='<input type="hidden" id="address_'+idx+'_lat" name="premium_quote_options[start_lat]" value=""/>';
							html +='<input type="hidden" id="address_'+idx+'_lng" name="premium_quote_options[start_lng]" value=""/>';
						return html;
					},
