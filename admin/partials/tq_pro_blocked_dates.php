<?php settings_fields( 'blocked_dates' ); ?>
<?php do_settings_sections( 'blocked_dates' ); ?>

<form class="admin-form tq-admin-form box-form round" id="edit_blocked_dates_form" method="post" autocomplete="false">
	<fieldset>
		<legend>Add  start/end date range for blocked dates:</legend>
	...
	<input type="hidden" name="update" value="blocked_dates"/>
	<div class="inline-field">
		<?php submit_button('Save Date', 'primary', 'save_blocked_date', true, array('class'=>'submit')); ?>
	</div>
	<div class="inline-field">
		<?php submit_button('Clear Form', 'primary', 'clear_blocked_date', true, array('class'=>'submit')); ?>
	</div>
	<div class="inline-field">
...
<form id="table-form" class="admin-form" method="post" action="options.php" autocomplete="false">
	...
	<table id="blocked_dates_table" class="settings-table">
		<thead>
			<!-- <th>Id</th> -->
			<th>Start Date</th>
			<th>End Date</th>
