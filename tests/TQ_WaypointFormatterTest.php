...
final class TQ_WaypointFormatterTest extends TestCase
{
    ...
    public function test_format() {
        ...
        foreach ($output as $waypoint) {

            $this->assertCount(12, $waypoint, ' not 12 elements');

            foreach ($waypoint as $field) {
...
echo json_encode($output);
        ...
        $waypoint = $output[1];
        $this->assertCount(9, $waypoint, ' not 9 elements');
