...
final class TQ_RequestParserGetQuoteReturnJourneyDispatchReturnBaseTest extends TestCase
{
    ...
    public function test_get_stage_data() {  
        ...
        $this->assertEquals('return_to_collection', $stage_data[1]['leg_type'], ' stage_data 1 is not return_to_collection');
        $this->assertEquals(16.825978868863, $stage_data[1]['distance'], ' stage_data 1 incorrect distance');
        $this->assertEquals(0.71277777777778, $stage_data[1]['hours'], ' stage_data 1 incorrect hours');

        $this->assertEquals('return_to_base', $stage_data[2]['leg_type'], ' stage_data 2 is not return_to_base');
        $this->assertEquals(21.27781230578, $stage_data[2]['distance'], ' stage_data 2 incorrect distance');
        $this->assertEquals(0.54972222222222, $stage_data[2]['hours'], ' stage_data 2 incorrect hours'); 
    }
    ...
    public function test_get_stage_data_two_drops() {  
        ...
        $this->assertEquals('standard', $stage_data[0]['leg_type'], ' stage_data 0 is not standard');
        $this->assertEquals(12.382224984462, $stage_data[0]['distance'], ' stage_data 0 incorrect distance');
        $this->assertEquals(0.54611111111111, $stage_data[0]['hours'], ' stage_data 0 incorrect hours');

        $this->assertEquals('return_to_collection', $stage_data[1]['leg_type'], ' stage_data 2 is not return_to_collection');
        $this->assertEquals(16.825978868863, $stage_data[1]['distance'], ' stage_data 2 incorrect distance');
        $this->assertEquals(0.71277777777778, $stage_data[1]['hours'], ' stage_data 2 incorrect hours');

        $this->assertEquals('return_to_base', $stage_data[2]['leg_type'], ' stage_data 3 is not return_to_base');
        $this->assertEquals(21.27781230578, $stage_data[2]['distance'], ' stage_data 3 incorrect distance');
        $this->assertEquals(0.54972222222222, $stage_data[2]['hours'], ' stage_data 3 incorrect hours'); 
    }
