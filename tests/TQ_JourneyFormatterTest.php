...
final class TQ_JourneyFormatterTest extends TestCase
{
	protected function setUp(){
        ...
        $this->expected_output_1 = json_decode('[{"label":"Distance","name":"distance","value":"665.05","type":"number"},{"label":"Estimated Travel Time","name":"time","value":"6.81","type":"number"}]', true);   

        $this->expected_output_1_not_empty = json_decode('[{"label":"Distance","name":"distance","value":"665.05","type":"number"}]', true);        
    }
