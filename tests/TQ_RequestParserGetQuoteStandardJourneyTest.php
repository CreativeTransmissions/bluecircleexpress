...
final class TQ_RequestParserGetQuoteStandardJourneyTest extends TestCase
{
    ...
    public function test_get_stage_data() {  
        ...
        $this->assertCount(1, $this->request_parser_get_quote_standard_journey->legs, ' does not have 1 leg');
