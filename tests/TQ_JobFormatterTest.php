...
final class TQ_JobFormatterTest extends TestCase
{
	protected function setUp(){
        ...
        $this->example_job = json_decode('{"id":"1","wp_user_id":"1","first_name":"Andrew","last_name":"Test","email":"test@test.com","phone":"4234324234","created":"2019-08-09 10:16:13","modified":"2019-08-09 10:16:13"} ', true);


        $this->example_job_2 = json_decode('{"id":"1","wp_user_id":"1","first_name":"Andrew","last_name":"Test","email":"test@test.com","phone":"","created":"2019-08-09 10:16:13","modified":"2019-08-09 10:16:13"} ', true);
