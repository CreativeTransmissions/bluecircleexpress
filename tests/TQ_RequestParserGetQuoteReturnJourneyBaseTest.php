...
final class TQ_RequestParserGetQuoteReturnJourneyBaseTest extends TestCase
{
    ...
    public function test_get_stage_data() {  
        ...
        $this->assertCount(3, $this->request_parser_get_quote_return_journey->legs, ' not 2 legs');
        ...
        $this->assertEquals(16.825978868863, $stage_data[0]['distance'], ' stage_data 0 incorrect distance');
        $this->assertEquals(0.71277777777778, $stage_data[0]['hours'], ' stage_data 0 incorrect hours');

        $this->assertEquals('return_to_base', $stage_data[1]['leg_type'], ' stage_data 3 is not return_to_base');
        $this->assertEquals(21.27781230578, $stage_data[1]['distance'], ' stage_data 3 incorrect distance');
        $this->assertEquals(0.54972222222222, $stage_data[1]['hours'], ' stage_data 3 incorrect hours'); 
    }
    ...
    public function test_get_stage_data_two_drops() {  
        ...
        $this->assertCount(4, $this->request_parser_get_quote_return_journey_two_drops->legs, ' not 3 legs');        ;
        $this->assertCount(2, $stage_data, ' stage_data does not have 2 stages');
