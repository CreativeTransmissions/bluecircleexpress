...
final class TQ_EmailRendererTest extends TestCase
{
	protected function setUp(){
        ...
        $this->expected_text_1 = urldecode('First+Name%3A+Andrew%0D%0ALast+Name%3A+Test%0D%0AEmail+Address%3A+test%40etset.com%0D%0APhone+Number%3A+345435345354%0D%0A%0D%0A');

        $this->expected_text_2 = urldecode('Information%3A+test%0D%0AVehicle%3A+Van%0D%0AService%3A+Standard%0D%0A%0D%0A');

        $this->expected_text_3 = urldecode('Pick+Up+Date%3A+August+8%2C+2019%0D%0APick+Up+Time%3A+12%3A00+pm%0D%0A%0D%0A');

        $this->expected_text_4 = urldecode('Distance+%28Kilometers%29%3A+663.2400%0D%0AEstimated+Travel+Time+%28Hours%29%3A+6.91%0D%0A%0D%0A');

        $this->expected_text_5 = urldecode('Distance+Cost%3A+1326.48%0D%0ASubtotal+%28GBP%29%3A+1326.48%0D%0ATotal+%28GBP%29%3A+1326.48%0D%0ARates%3A+Standard%0D%0A%0D%0A');
