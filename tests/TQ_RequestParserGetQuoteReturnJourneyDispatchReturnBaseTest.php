...
final class TQ_RequestParserGetQuoteReturnJourneyDispatchReturnTest extends TestCase
{
    ...
    public function test_get_stage_data() {  
        ...
        $this->assertCount(4, $this->request_parser_get_quote_return_journey->legs, ' not 4 legs');
        $this->assertCount(4, $stage_data, ' stage_data does not have 4 stages');
        ...
        $this->assertEquals('return_to_base', $stage_data[3]['leg_type'], ' stage_data 3 is not return_to_base');
        $this->assertEquals(21.27781230578, $stage_data[3]['distance'], ' stage_data 3 incorrect distance');
        $this->assertEquals(0.54972222222222, $stage_data[3]['hours'], ' stage_data 3 incorrect hours'); 
    }
    ...
    public function test_get_stage_data_two_drops() {  
        ...
        $this->assertCount(5, $this->request_parser_get_quote_return_journey_two_drops->legs, ' not 5 legs');        ;
        $this->assertCount(4, $stage_data, ' stage_data does not have 4 stages');
