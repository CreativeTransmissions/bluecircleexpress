...
final class TQ_RequestParserGetQuoteReturnJourneyTest extends TestCase
{
    ...
    public function test_get_stage_data() {  
        ...
        $this->assertEquals(41.503418272219, $stage_data[0]['distance'], ' stage_data 0 incorrect distance');
        $this->assertEquals(1.4477777777778, $stage_data[0]['hours'], ' stage_data 0 incorrect hours');
    ...
    public function test_get_stage_data_two_drops() {  
        ...
        $this->assertCount(1, $stage_data, ' stage_data does not have 1 stages');
        $this->assertEquals('standard', $stage_data[0]['leg_type'], ' stage_data 0 is not standard');
        $this->assertEquals(38.44437538844, $stage_data[0]['distance'], ' stage_data 0 incorrect distance');
        $this->assertEquals(1.5766666666667, $stage_data[0]['hours'], ' stage_data 0 incorrect hours');
