...
final class TQ_QuoteFormatterTest extends TestCase
{
	protected function setUp(){
        ...
        $this->expected_output_non_zero = json_decode('[{"label":"Distance Cost","name":"distance_cost","value":"1764.08","type":"number"},{"label":"Subtotal (GBP)","name":"basic_cost","value":"1764.08","type":"number"},{"label":"Total (GBP)","name":"total","value":"1764.08","type":"number"},{"label":"Rates","name":"job_rate","value":"Standard","type":"text"}]', true);        
    }
