...
class TQ_LabelFetcher {
	...
	return array(		'contact_section_title' => $this->public->get_setting('tq_pro_form_options','contact_section_title', 'Your Contact Information'),
        				...
        				'first_name' => $this->public->get_setting('tq_pro_form_options','first_name', 'First Name'),
        				'last_name' => $this->public->get_setting('tq_pro_form_options','last_name', 'Last Name'),
        				'phone' => $this->public->get_setting('tq_pro_form_options','phone', 'Phone Number'),
						...
						'contact_phone' => $this->public->get_setting('tq_pro_form_options','contact_phone', ''),
