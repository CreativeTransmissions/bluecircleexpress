...
class TQ_LabelFetcher {
	...
	return array(		'contact_section_title' => $this->public->get_setting('tq_pro_form_options','contact_section_title', 'Your Contact Information'),
        				...
        				'delivery_information_label' => $this->public->get_setting('tq_pro_form_options','delivery_information_label', 'Delivery Information'),
						...
						'route_label' => $this->public->get_setting('tq_pro_form_options','route_label', ''),
