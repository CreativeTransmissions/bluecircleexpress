    ...
    <legend><?php echo self::get_setting('tq_pro_form_options','search_section_title', 'Enter Addresses'); ?></legend>
        <div class="address-wrap">
            ...
            <div class="inline-block bt-flabels__wrapper half left">
                <input class="inline-block half-field" type="text" id="address_0_appartment_no" name="address_0_appartment_no" placeholder="<?php echo self::get_setting('tq_pro_form_options','unit_no_label', 'Unit No'); ?>" value=""/>
            </div>
            <?php } ?>
        ...
        <div class="address-wrap">
            ...
            <?php if($this->ask_for_unit_no){ ?>
            <div class="inline-block bt-flabels__wrapper half left">
                <input class="inline-block half-field " type="text" id="address_1_appartment_no" name="address_1_appartment_no" placeholder="<?php echo self::get_setting('tq_pro_form_options','unit_no_label', 'Unit No'); ?>" value=""/>
            </div>
            <?php } ?>
            <?php if($this->ask_for_postcode){ ?>
            <div class="inline-block bt-flabels__wrapper half right last-address-field">
