    ...
    <legend><?php echo self::get_setting('tq_pro_form_options','search_section_title', 'Enter Addresses'); ?></legend>
        <div class="address-wrap">
            ...
            <div class="inline-block bt-flabels__wrapper half left">
                <input class="inline-block half-field" type="text" id="address_0_appartment_no" name="address_0_appartment_no" data-parsley-maxlength="20" placeholder="<?php echo self::get_setting('tq_pro_form_options','unit_no_label', 'Unit No'); ?>" value=""/>
            </div>
            <?php } ?>
            <?php if($this->ask_for_postcode){ ?>
            <div class="inline-block bt-flabels__wrapper half right last-address-field">
                <input class="inline-block postcode half-field half-field-right" type="text" id="address_0_postal_code" name="address_0_postal_code" data-parsley-maxlength="16" placeholder="Postcode" value=""/>
            </div>
            <?php } ?>
        </div>
        <div class="address-wrap">
