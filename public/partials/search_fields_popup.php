<fieldset class="search-fields">
    ...
    <div class="tq-row"> 
        <div class="columns small-12 medium-6 bt-flabels__wrapper"> 
            ...
            <span class="bt-flabels__error-desc">Required Collection</span>
         </div>
        <div class="columns small-12 medium-6 bt-flabels__wrapper"> 
            <label for="drop_off">Delivery Address</label>
            <input type="text" required name="moving_to" id="moving-to"class="popup-with-form moving-to"  placeholder="Delivery"><span class="bt-flabels__error-desc">Required Delivery</span>
        </div>
    </div>
</fieldset>