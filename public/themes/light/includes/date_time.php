<div class="date-wrap">
	<?php if($this->ask_for_date){ ?>    
	    <div class="coll_date_wrap bt-flabels__wrapper">
	    	<label for="date"><i class="icon icon-icn-date"></i><?php echo self::get_setting('tq_pro_form_options','collection_date_label', 'Collection Date'); ?></label>
	...
	<?php if($this->ask_for_time){ ?>
	    <div class="coll_time_wrap bt-flabels__wrapper">
	    	<label for="delivery_time"><i class="icon icon-icn-time"></i><?php echo self::get_setting('tq_pro_form_options','collection_time_label', 'Collection Time'); ?></label>
