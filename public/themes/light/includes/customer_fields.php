    ...
    <div class="transit_body tq-form-bg-color">
        <div class="full">
            <div class="left half bt-flabels__wrapper">
                ...
                <input type="text" name="first_name" required data-parsley-maxlength="45" placeholder="Enter <?php echo $this->view_labels['first_name']; ?>">
            ...
            <div class="right half bt-flabels__wrapper">
                ...
                <input type="text" name="last_name" required  data-parsley-maxlength="45" placeholder="Enter <?php echo $this->view_labels['last_name']; ?>">
        ...
        <div class="full">
            <div class="left half bt-flabels__wrapper">
                ...
                <input type="text" data-parsley-type="number" required name="phone" class="phone" data-parsley-maxlength="45" placeholder="Enter your <?php echo $this->view_labels['phone']; ?>">
            ...
            <div class="right half bt-flabels__wrapper">
                ...
                <input type="text" data-parsley-type="email" name="email" required data-parsley-maxlength="128" placeholder="Enter your <?php echo $this->view_labels['email']; ?>">
